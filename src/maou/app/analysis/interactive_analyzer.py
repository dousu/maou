...
class EngineSettings:
    ...
    def describe(self) -> dict[str, Any]:
        ...
        return {
            ...
            "defensive_mate": self.defensive_mate,
            "defensive_mate_threads": self.defensive_mate_threads,
        }
...
class InteractiveAnalyzer:
    ...
    def _search(
        ...
        return engine.search(
            ...
            defensive_mate=s.defensive_mate,
            defensive_mate_threads=s.defensive_mate_threads,
        )
