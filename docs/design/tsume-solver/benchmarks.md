...
| 優先度 | 課題 | v0.24.60 時点 | v0.24.66 時点 |
|:---:|:---|:---|:---|
| **中** | IDS 間 intermediate 消失 | v0.24.45 の選択的保持のまま | warmup 後の `retain_proofs_only` (v0.24.66) が intermediate を clear するため，warmup 使用時は intermediate 保持が無効化される．warmup なしの通常 solve では v0.24.45 のまま |
