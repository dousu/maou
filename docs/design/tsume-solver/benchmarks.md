...
| Ply | Remaining | v0.24.33 (120M) | v0.24.33 (500M) | v0.24.60 (10M) | v0.24.60 (120M) |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 38-26 | 1-13 | <1K Mate | <1K Mate | <1K Mate | <1K Mate |
| 24 | 15 | 367K Mate(15) | 367K Mate(15) | 450K Mate(15) | 450K Mate(15) |
| 22 | 17 | 38M Mate(17) | 16.9M Mate(17) | **8.09M Mate(17)** | 17.3M Mate(17) |
| 20 | 19 | Unknown | 202M Mate(19) | Unknown | **93.4M MateNoPV** |
| 18 | 21 | 未測定 | 243M Mate(21) | Unknown | 未到達 |
| 16 | 23 | 119M MateNoPV | 454M MateNoPV | Unknown | 未到達 |
| 14 | 25 | Unknown | 498M Mate(25) | Unknown | 未到達 |
| 12 | 27 | 未到達 | **Unknown** (500M cap) | Unknown | 未到達 |
...
2. **ply 20 が 120M budget で解けるようになった**:
   v0.24.33 では 120M で Unknown，500M で 202M Mate(19) だった．
   v0.24.60 では 120M budget 内の **93.4M nodes** で MateNoPV に到達
   (**2.2 倍高速化**)．PV 抽出は未成功だが proof は確認済み．

3. **NPS 改善**: ply 20 の NPS が v0.24.33 の ~6K/s → v0.24.60 の
   ~104K/s に改善 (**17 倍**)．TT 管理の効率化が寄与．

4. **120M budget の境界前進**: v0.24.33 では ply 16 (MateNoPV) が
   120M の限界だったが，v0.24.60 では ply 20 が 93.4M で解けるため
   **さらに深い ply まで 120M で到達可能** と推測される
   (ply 18/16 の v0.24.60 120M 測定は未実施)．

###### 未解決の境界と残る課題

- **v0.24.33 (500M) の境界**: ply 12 (Unknown)．ply 14 まで解決可能．
- **v0.24.60 (120M) の境界**: ply 18 以浅が未測定．500M budget での
  v0.24.60 測定が必要 (ply 12→10 への前進の可能性)．
- **ply 20 の PV 抽出**: MateNoPV → PV visit 予算調整で改善可能な見込み．
- **full puzzle (ply 0)**: 前半 (ply 0→12) の推定コストは数十億 nodes．
  現行の budget 上限 (500M) では到達不能．
