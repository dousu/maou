...
| Ply | Remaining | v0.24.33 (120M) | v0.24.60 (10M) | v0.24.60 (120M) | 改善率 |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 38-26 | 1-13 | <1K Mate | <1K Mate | <1K Mate | 同等 |
| 24 | 15 | 367K Mate(15) | 450K Mate(15) | 450K Mate(15) | 同等 |
| 22 | 17 | 38M Mate(17) | **8.09M Mate(17)** | 17.3M Mate(17) | **4.7x** (10M) |
| 20 | 19 | **Unknown** | Unknown | **93.4M MateNoPV** | **新規突破** |
| 18 | 21 | 未測定 | Unknown (10M) | 未到達 | — |
| 14 | 25 | Mate(25) (500M) | Unknown (10M) | 未到達 | — |

###### 主要な発見

1. **ply 22 が 4.7 倍高速化** (38M → 8.09M): multi-step cross\_deduce
   (v0.24.59) と IDS warmup (v0.24.60) の累積効果．

2. **ply 20 が初めて解けた** (93.4M nodes, 899s, MateNoPV):
   v0.24.33 baseline では 120M nodes + 30min で Unknown だった
   sub-problem が v0.24.60 で MateNoPV に到達．PV 抽出は未成功
   (MateNoPV) だが proof は確認済み．

3. **ply 20 の NPS**: ~104K (ply 22 の ~83K に近い)．v0.24.33 での
   NPS 崩壊 (6K) が大幅改善．

4. **境界の前進**: 120M budget での未解決境界が ply 20 → ply 18 に
   2 ply 前進．

###### 残る課題

- **ply 18 以浅**: 10M/120M budget では Unknown．推定 500M+ nodes 必要．
- **ply 20 の PV 抽出**: MateNoPV (proof 確認済みだが PV 不完全)．
  PV visit 予算の調整で改善可能な見込み．
- **full puzzle (ply 0)**: 前半 (ply 0→20) の推定コストは数十億 nodes．
  現行 budget では到達不能．
