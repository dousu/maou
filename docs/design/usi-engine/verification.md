...
**aggregator の価値 (2026-07-28 更新)**: 伸びしろ約 2 倍 = 予算 1 doubling 相当で，
§3.1 の実測 (**1 doubling ≈ +208 Elo [+52, +364]**) を当てると **+208 Elo 級**の
期待値になる．旧換算 (60 Elo) の 3.5 倍で，**現時点で最も期待値の大きい未着手項目**．
n=12 の CI は広いので，着手前に §3 を n ≥ 24 で回して換算係数を締めること．
