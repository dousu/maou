...
class TestHCPEConverter:
    ...
    def clean_up_dir(self, dir: Path):
        if dir.exists() and dir.is_dir():
            for f in dir.glob("**/*"):
                f.unlink()

    def test_successfull_conversion(self, default_fixture):
        input_paths = [
    ...
    def test_failed_conversion_no_input(self, default_fixture):
        input_paths = [
            Path(
                "tests/maou/app/converter/resources/test_dir/input/test_data_not_exists.csa"
            ),
        ]
        output_dir = Path("tests/maou/app/converter/resources/test_dir/output")
        option: hcpe_converter.HCPEConverter.ConvertOption = (
    ...
    def test_failed_conversion_not_applicable_format(self, default_fixture):
        input_paths = [
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_1.csa"),
        ]
        output_dir = Path("tests/maou/app/converter/resources/test_dir/output")
    ...
    def test_failed_conversion_no_output(self, default_fixture):
        input_paths = [
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_1.csa"),
        ]
        output_dir = Path(
    ...
    def test_conversion_filter_min_rating(self, default_fixture):
        input_paths = [
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_1.csa"),
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_2.csa"),
        ]
    ...
    def test_conversion_filter_min_moves(self, default_fixture):
        input_paths = [
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_1.csa"),
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_2.csa"),
        ]
    ...
    def test_conversion_filter_max_moves(self, default_fixture):
        input_paths = [
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_1.csa"),
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_2.csa"),
        ]
    ...
    def test_conversion_filter_allowed_endgame_status(self, default_fixture):
        input_paths = [
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_1.csa"),
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_2.csa"),
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_3.csa"),
    ...
    def test_conversion_composite_filter_(self, default_fixture):
        input_paths = [
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_1.csa"),
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_2.csa"),
            Path("tests/maou/app/converter/resources/test_dir/input/test_data_3.csa"),
