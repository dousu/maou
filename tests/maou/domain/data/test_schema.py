...
class TestHCPESchema:
    ...
    def test_get_hcpe_dtype(self):
        ...
        if dtype.names is not None:
            assert dtype["hcp"].shape == (32,)
            assert dtype["hcp"].subdtype[0] == np.uint8
        assert dtype["eval"] == np.int16
        assert dtype["bestMove16"] == np.int16
        assert dtype["gameResult"] == np.int8
        assert dtype["ratings"].shape == (2,)
        assert dtype["ratings"].subdtype[0] == np.uint16
        assert dtype["moves"] == np.int16

    def test_hcpe_dtype_constant(self):
        """Test HCPE_DTYPE constant matches function."""
        assert HCPE_DTYPE == get_hcpe_dtype()

    def test_create_empty_hcpe_array(self):
    ...
    def test_validate_hcpe_array_valid(self):
    ...
    def test_validate_hcpe_array_wrong_type(self):
    ...
    def test_validate_hcpe_array_wrong_dtype(self):
    ...
    def test_validate_hcpe_array_eval_out_of_range(self):
    ...
    def test_validate_hcpe_array_invalid_game_result(self):
    ...
    def test_validate_hcpe_array_negative_moves(self):
    ...
    def test_validate_empty_hcpe_array(self):
...
class TestPreprocessingSchema:
    ...
    def test_get_preprocessing_dtype(self):
        ...
        assert dtype["features"].subdtype[0] == np.uint8
        assert dtype["moveLabel"] == np.uint16
        assert dtype["resultValue"] == np.float16
        assert dtype["legalMoveMask"].shape == (MOVE_LABELS_NUM,)
        assert dtype["legalMoveMask"].subdtype[0] == np.uint8

    def test_preprocessing_dtype_constant(self):
        """Test PREPROCESSING_DTYPE constant matches function."""
        assert PREPROCESSING_DTYPE == get_preprocessing_dtype()

    def test_create_empty_preprocessing_array(self):
    ...
    def test_validate_preprocessing_array_valid(self):
    ...
    def test_validate_preprocessing_array_wrong_type(self):
        """Test validation with wrong input type."""
        with pytest.raises(SchemaValidationError, match="Expected numpy ndarray"):
            validate_preprocessing_array("not an array")

    def test_validate_preprocessing_array_wrong_dtype(self):
        """Test validation with wrong dtype."""
        wrong_array = np.array([1, 2, 3], dtype=np.float32)
        with pytest.raises(SchemaValidationError, match="Invalid dtype"):
            validate_preprocessing_array(wrong_array)

    def test_validate_preprocessing_array_eval_out_of_range(self):
        """Test validation with eval values out of range."""
    ...
    def test_validate_preprocessing_array_move_label_out_of_range(self):
    ...
    def test_validate_preprocessing_array_result_value_out_of_range(self):
    ...
    def test_validate_preprocessing_array_wrong_features_shape(self):
    ...
    def test_validate_empty_preprocessing_array(self):
        """Test validation of empty array."""
...
class TestSchemaIntegration:
    ...
    def test_schema_consistency_with_constants(self):
    ...
    def test_array_creation_and_validation_integration(self):
