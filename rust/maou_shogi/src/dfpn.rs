...
mod tests {
    ...
    fn test_profile_solve() {
        ...
        for (name, sfen, depth, nodes, timeout) in &cases {
            ...
            let solver = DfPnSolver::with_timeout(*depth, *nodes, 32767, *timeout as u64);
            ...
            println!("{:<20} {:>10.1} {:>10} {:>10.0} {:>8} {:>7.1}%",
                name, wall_ms, nodes_searched, nps,
