...
status: rejected  # 2026-06-22 reconcile: findings doc with NO durable-doc apply target; conclusions already absorbed into compass + worklog. Retained as do-not-redo provenance. (terminal `rejected` status formalized in docs/memory-architecture.md @ 9bdb55b)
date: 2026-06-14
