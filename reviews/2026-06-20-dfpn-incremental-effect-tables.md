...
status: rejected  # 2026-06-22 reconcile: experiment completed but measured-REJECTED (effect tables net 非償却 +5s, §10); compass records ❌棄却確定/再実行禁止. Retained as do-not-redo provenance. (terminal `rejected` status formalized in docs/memory-architecture.md @ 9bdb55b)
date: 2026-06-20
